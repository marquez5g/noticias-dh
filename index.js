const noticias = [
    ...
    descripcion: "La cantante fue vista averiguando sobre escuelas enLos Ángeles, lo que hace suponer que podría mudarse con sus hijos allípara estar cerca del actor",
    fecha:"02/06/21",
    tipoNacional: false
...
noticias.forEach(noticia => {
    const noticiaNode = document.createElement("article");
    if(noticia.tipoNacional){
        noticiaNode.innerHTML=
        `
        <div class="news national">
            <span class="date">${noticia.fecha}</span>
            <img class="news_image" src="${noticia.imgUrl}" alt="">
    ...
    newsContainer.appendChild(noticiaNode);
});
